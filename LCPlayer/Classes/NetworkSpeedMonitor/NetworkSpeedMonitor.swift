...
@objc public class NetworkSpeedMonitor: NSObject {
    /// 单例
//    @objc public static let shared = NetworkSpeedMonitor()
    // 代理
    @objc public weak var delegate: NetworkSpeedMonitorProtocol?
...
@objc public protocol NetworkSpeedMonitorProtocol: AnyObject {
